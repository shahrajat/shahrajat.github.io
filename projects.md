...
-  **[Adwords Placement](https://github.com/shahrajat/Data-Science/tree/master/adwords-placement)** - Given that Advertisement Giants like Google, Yahoo only get paid by advertisers only if the viewer clicks the ads, it's important to make the decision of which Ads should be shown (in limited number of ads slots available) depending on the query typed. Implemented Greedy, MSVV, and Balance algorithms in R for a very simplified version of this problem statement. MSSV beats other algorithms in terms of total revenue generated.
